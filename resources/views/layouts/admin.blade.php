            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        <li class="nav-item {{Request::segment(1)=='dashboard-admin'? 'active':''}}">
                            <a href="{{ url('dashboard-admin') }}" class="nav-link"><i
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link {{Request::segment(1)=='biodata-peserta'? 'active':''}}"
                                        href="{{ url('biodata-peserta') }}">Biodata</a></li>
                                <li><a class="nav-link {{Request::segment(1)=='administrasis-peserta'? 'active':''}}"
                                        href="{{ url('administrasis-peserta') }}">Administrasi</a></li>
                                <li><a class="nav-link {{Request::segment(1)=='nilai-peserta'? 'active':''}}"
                                        href="{{ url('nilai-peserta') }}">Nilai</a></li>
                            </ul>
                        </li>
                        <li class="nav-item {{Request::segment(1)=='beritas-admin'? 'active':''}}">
                            <a href={{ url('beritas-admin') }} class="nav-link "><i class="far fa-file-alt"></i>
                                <span>Berita</span></a>
                        </li>
                        <li class="nav-item {{Request::segment(1)=='proker-admin'? 'active':''}}">
                            <a href={{ url('proker-admin') }} class="nav-link"><i class="far fa-file-alt"></i>
