                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="{{ url('profile-peserta') }}" class="dropdown-item has-icon">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        <li class="nav-item {{Request::segment(1)=='dashboard-peserta'? 'active':''}}">
                            <a href="{{ url('dashboard-peserta') }}" class="nav-link "><i
                                    class=""></i><span>Dashboard</span></a>
                        </li>
                        <li class="nav-item {{Request::segment(1)=='administrasi-peserta'? 'active':''}}">
                            <a href="{{ url('administrasi-peserta') }}" class="nav-link"><i class="far fa-file-alt"></i>
