...
<head>
  ...
  <title>Register&mdash; Duta Baca Indramayu</title>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="{{asset('web/node_modules/bootstrap-social/bootstrap-social.css')}}">
...
<body
  style="background-image: url('{{ asset('images/bg/background.jpg') }}'); background-size: cover; background-position: center center;">
  <div id="app">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              {{-- <img src="web/assets/img/stisla-fill.svg" alt="logo" width="100" class="shadow-light rounded-circle">
              --}}
            </div>

            <div class="card card-primary">
              <div class="card-header">
                <h4 class="text-center">DUTA BACA KABUPATEN INDRAMAYU</h4>
              </div>
              ...
              <div class="card-body">
                <form method="POST" action="{{route('registration')}}" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <input id="tgl_lahir" type="date" class="form-control" name="tgl_lahir" tabindex="1" required
                      autofocus>
                    <div class="invalid-feedback">
                  ...
                  <div class="form-group">
                    ...
                    <input id="instansi" type="text" class="form-control" name="instansi" tabindex="1" required
                      autofocus>
                    <div class="invalid-feedback">
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="text" class="form-control" name="password" tabindex="1" required
                      autofocus>
                    <div class="invalid-feedback">
  ...
  <script src="{{asset('web/assets/js/stisla.js')}}"></script>
