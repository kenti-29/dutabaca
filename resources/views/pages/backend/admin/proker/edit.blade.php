        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('proker-admin.update', $proker->id)}}"
                            ...
                            <div class="form-group">
                                ...
                                <input id="nama" type="text" class="form-control" name="nama"
                                    value="{{ $proker->nama }}" tabindex="1" required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <input id="deskripsi" type="text" class="form-control" name="deskripsi"
                                    value="{{ $proker->deskripsi }}" tabindex="1" required autofocus>
                                <div class="invalid-feedback">
