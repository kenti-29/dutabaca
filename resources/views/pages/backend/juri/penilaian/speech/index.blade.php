...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="{{url('speech-juri')}}">Speech</a></div>
        </div>
    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ count($administrasi->penilaian) >0 ?
                                                    ...
                                                    $administrasi->id)->first()->nilai_speech : '0'}}
                                                    <a
                                                        href="{{ route('speech-juri.edit', $administrasi->id) }}">Edit</a>

                                                </td>
                                                <td>{{
                                                    $administrasi->Penilaian?$administrasi->Penilaian->sum('nilai_speech'):0
                                                    }}</td>
                                            </tr>
                                            {{-- @endforeach --}}
                                            @endforeach
