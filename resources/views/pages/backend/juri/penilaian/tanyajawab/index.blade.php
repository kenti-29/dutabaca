...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="{{url('tanyajawab-juri')}}">Tanya Jawab</a></div>
        </div>
    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ count($administrasi->penilaian) >0 ?
                                                    ...
                                                    $administrasi->id)->first()->nilai_tanyajawab : '0'}}
                                                    <a
                                                        href="{{ route('tanyajawab-juri.edit', $administrasi->id) }}">Edit</a>

                                                </td>
                                                <td>{{
                                                    $administrasi->Penilaian?$administrasi->Penilaian->sum('nilai_tanyajawab'):0
                                                    }}</td>
                                            </tr>
                                            {{-- @endforeach --}}
                                            @endforeach
