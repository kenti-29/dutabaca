...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="{{url('testulis-juri')}}">Tes Tulis</a></div>
        </div>
    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ count($administrasi->penilaian) >0 ?
                                                    ...
                                                    $administrasi->id)->first()->nilai_testulis : '0'}}
                                                    <a
                                                        href="{{ route('testulis-juri.edit', $administrasi->id) }}">Edit</a>

                                                </td>
                                                <td>{{
                                                    $administrasi->Penilaian?$administrasi->Penilaian->sum('nilai_testulis'):0
                                                    }}</td>
                                            </tr>
                                            {{-- @endforeach --}}
                                            @endforeach
