...
class SpeechController extends Controller
{
    ...
    public function index()
    {
         $administrasis = Administrasi::with(['user','penilaian' => function ($q)
     {
        ...
        return view('pages.backend.juri.penilaian.speech.index', compact('administrasis')) ;
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.backend.juri.penilaian.speech.edit', compact('id', 'penilaian'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($cek == 0){
            Penilaian::create([
                ...
                'nilai_speech'=> ($request->nilai_speech)
            ]);
            return redirect()->route('speech-juri.index')->with('status', 'Berhasil  Mengupdate Nilai');
        }
